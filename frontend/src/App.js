                ...
                <RoutesWrapper isDarkMode={isDarkMode}>
                    <Routes>
                        <Route element={<ProtectedRoute isAllowed={!AuthService.getCurrentUser()} />}>
                            ...
                            <Route path='/auth/forgotPassword/verifyEmail' element={<ForgotPasswordEmailVerfication />} />
                        ...
                        <Route element={<ProtectedRoute isAllowed={Boolean(currentUser) && userRoles.has("ROLE_USER")} />}>
                        ...
                        <Route element={<ProtectedRoute isAllowed={Boolean(currentUser) && userRoles.has("ROLE_ADMIN")} />}>
