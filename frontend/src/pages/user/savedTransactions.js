          ...
          t.dueInformation && (
            <div className="st-card" key={t.planId}>
              <div className="topic">
                ...
                <h4 className="amount">
                  {t.transactionType === 1 ? '- ' : '+ '} Rs. {t.amount}
                </h4>
              </div>
              ...
              <div className="actions">
                <button className="confirm-btn" onClick={() => saveTransaction(t.planId)}>Confirm</button>
                <button className="button outline ghost-btn" onClick={() => skipTransaction(t.planId)}>
                  Skip
                </button>
                <Link to={`/user/editSavedTransaction/${t.planId}`}>
                  <button className="button outline ghost-btn">Edit</button>
                </Link>
              </div>
            </div>
          )
