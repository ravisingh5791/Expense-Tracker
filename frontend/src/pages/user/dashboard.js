...
function Dashboard() {
  ...
  const [total_expense, total_income, cash_in_hand, no_of_transactions, categorySummary, budgetAmount, saveBudget, isLoading, isError] =
...
function SelectMonth({ months, onMonthChange }) {
  return (
    <div className="dashboard-month fade-in">
